...
class Google():
    ...
    def get_image_links(self, main_keywords, pre_link_path, fileNames):
        for i in range(len(main_keywords)):
            ...
            retry_count = 0
            while True:
                image_elements = self.driver.find_elements_by_xpath('//div[contains(@class,"rg_meta")]')
...
if __name__ == "__main__":
    ...
    #                  '火锅', '冒菜']
    # fileNames = [
    #     "苹果派(苹果馅饼)","酸辣汤(胡辣汤)","重庆火锅"
    # ]
    # main_keywords = ['Apple pie',"胡辣汤","重庆火锅"]

    # fileNames = [
    #     "山楂果丹皮","鱼馅饼","发糕","羊肉泡膜",
    # ]
    # main_keywords = ['果丹皮',"鱼馅饼",发糕","羊肉泡膜",]
    # fileNames = [
    #     "发糕", "羊肉泡膜","印度咖喱羊肉煲",
    # ]
    # main_keywords = ["发糕", "羊肉泡膜","羊肉煲", ]
    fileNames = [
        "印度咖喱羊肉煲",
    ]
    main_keywords = [ "羊肉煲", ]
    ...
    # single process
    # google=Google()
    # google.get_image_links(main_keywords,link_files_dir,fileNames)
    #
