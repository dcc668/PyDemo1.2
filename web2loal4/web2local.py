...
import json, random, os, re, urllib
...
class Runthread(QThread):
    ...
    def __init__(self,download,args):
    ...
    def run(self):
        msg=True
        self.download.download_scripy(self.args[0],self.args[1],self.args[2])
        print('=================----------end------------=================')
